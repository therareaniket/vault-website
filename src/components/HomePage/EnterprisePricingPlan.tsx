...
type EnterprisePricingPlanProps = {
  price: string;
  oldprice: string;
  features: string[];
};

const EnterprisePricingPlan = ({ price, oldprice, features }: EnterprisePricingPlanProps) => {
  return (
    <div className="pricing-content">
      <div className="pricing-left">
        <div className="pricing-left-text">
          ...
          <Link href="/Contact#ContactFrom" className="start-btn btn-padding btn-bg btn-primary text-18 text-md text-center">
